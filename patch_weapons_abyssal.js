  ...
  soul_reaper:{id:'soul_reaper',name:'Жнец Душ',icon:'☠️',color:'#00ff00',cd:0.04,pellets:1,spread:0,jitter:0.1,speed:1600,dmg:2,ammoMax:150,reload:2.5,pierce:3,auto:true, ricochet:false, evolved:true},
  ...
  minigun:{id:'minigun',name:'Костяной Шквал',icon:'🦴',color:'#ffffaa',cd:0.03,pellets:1,spread:0,jitter:0.15,speed:1500,dmg:1,ammoMax:120,reload:2.0,pierce:2,auto:true, ricochet:true, evolved:true},
  abyssal_rift:{id:'abyssal_rift',name:'Разлом Бездны',icon:'🌌',color:'#800080',cd:0.9,pellets:1,spread:0,jitter:0,speed:700,dmg:15,ammoMax:5,reload:2.2,pierce:1,auto:false,splash:220, evolved:true}
};
...
const EVOLUTIONS = {
  ...
  'necro_crossbow': { affix: 'reload_up', target: 'soul_reaper' },
  'void_shard': { affix: 'dmg', target: 'abyssal_rift' }
};
